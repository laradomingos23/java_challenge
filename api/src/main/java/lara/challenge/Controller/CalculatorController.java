...
public class CalculatorController {
    ...
    @GetMapping("/sub")
    public CalculatorResponse subtract(@RequestParam("a") BigDecimal a, @RequestParam("b") BigDecimal b) throws Exception {
        logger.info("Received subraction request: a={}, b={}", a, b);
        return handleOperation(a, b, "SUBTRACT");
    }

    @GetMapping("/mul")
    public CalculatorResponse multiply(@RequestParam("a") BigDecimal a, @RequestParam("b") BigDecimal b) throws Exception {
        logger.info("Received multiplication request: a={}, b={}", a, b);
        return handleOperation(a, b, "MULTIPLY");
    }

    @GetMapping("/div")
    public CalculatorResponse divide(@RequestParam("a") BigDecimal a, @RequestParam("b") BigDecimal b) throws Exception {
